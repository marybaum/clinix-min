...
load_child_theme_textdomain( 'minimum', apply_filters( 'child_theme_textdomain', get_stylesheet_directory() . '/languages', 'clinixmin' ) );

//* Child theme (do not remove)
define( 'CHILD_THEME_NAME', __( 'Minimum Pro Theme', 'clinixmin' ) );
...
add_image_size( 'homethumb', 300, 999, TRUE );
...
function minimum_portfolio_post_type() {
  ...
  register_post_type( 'portfolio',
    array(
      'labels' => array(
        'name'          => __( 'Portfolio', 'clinixmin' ),
        'singular_name' => __( 'Portfolio', 'clinixmin' ),
      ),
...
genesis_register_sidebar( array(
  ...
  'name'        => __( 'Site Tagline Right', 'clinixmin' ),
  'description' => __( 'This is the site tagline right section.', 'clinixmin' ),
) );
genesis_register_sidebar( array(
  'id'          => 'home-featured-1',
  'name'        => __( 'Home Featured 1', 'clinixmin' ),
  'description' => __( 'This is the home featured 1 section.', 'clinixmin' ),
) );
genesis_register_sidebar( array(
  'id'          => 'home-featured-2',
  'name'        => __( 'Home Featured 2', 'clinixmin' ),
  'description' => __( 'This is the home featured 2 section.', 'clinixmin' ),
) );
genesis_register_sidebar( array(
  'id'          => 'home-featured-3',
  'name'        => __( 'Home Featured 3', 'clinixmin' ),
  'description' => __( 'This is the home featured 3 section.', 'clinixmin' ),
) );
